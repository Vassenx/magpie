...
namespace Magpie
{
    public class OptionsMenu : MonoBehaviour
    {
        ...
        // TODO cache default settings to be able to revert to default
        ...
        private void OnEnable()
        {
            ...
            EventSystem.current.SetSelectedGameObject(visualsButton.gameObject);
        }
        
        public void OnHighlightButton(Button button) // visuals update
        {
            bool enable = false;
            foreach (var curButton in navBarButtons)
            {
        ...
        public void OnVisualsButtonClicked() => SwitchPage("visuals");
        
        public void OnAudioButtonClicked() => SwitchPage("audio");
        
        public void OnControlsButtonClicked() => SwitchPage("controls");

        public void OnBackButtonClicked() => PopUp.instance.DisplayPopUp(menuManager.PopUpCloseOptions, null); 
        ...
        public void OnClickRevertToDefault()
        {
            ...
            curPopUp.DisplayPopUp(RevertToDefault, EventSystem.current.currentSelectedGameObject);
        }
