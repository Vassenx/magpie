...
{
    /// <summary>Information about when and how to activate a <see cref="HitBox"/> during an attack animation.</summary>
    /// <remarks>
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                if (end < normalizedEndTime)
                {
                    previousIndex = events.Add(previousIndex + 1, end, () =>
                    {
                        ...
                        if (attackerFighter != null)
                        {
                            attackerFighter.RemoveHitBox(hit);
                        }
                    });
                }
            }
